...
> Which version of asset-manager-core are you using?

e.g. `0.1.0`

> What version of React are you using asset-manager-core within?
...
1. fixed in the next release (https://github.com/phantomstudios/asset-manager-core/blob/master/CHANGELOG.md)
