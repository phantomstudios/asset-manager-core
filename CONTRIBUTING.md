...
[list of issues](https://github.com/phantomstudios/asset-manager-core/issues).
...
Please send a
[GitHub Pull Request to asset-manager-core](https://github.com/phantomstudios/asset-manager-core/pull/new/master)
...
- You ought to be able to find any previous version easily using GitHub tabs, or
  [Releases](https://github.com/phantomstudios/asset-manager-core/releases)
